...
('conjunto elitstyle', 'Casaco preto e camiseta "elitstyle". Exclusividade, classe e conforto.', 1887.00, 8, '/img/produtos/conjunto-03.jpg'),
('imperial beige ensemble', 'Conjunto com jaqueta bege refinada. Discreto e sofisticado.', 2542.00, 5, '/img/produtos/conjunto-4.jpg'),
('supreme streetwear edition', 'Suéter premium com logo "streetwear". Minimalista, confortável e elegante.', 429.00, 5, '/img/produtos/imgl1.png'),
('obsidian luxe tee', 'Camiseta preta unissex. Simples, exclusiva e luxuosa.', 449.00, 18, '/img/produtos/imgl2.png'),
('emerald prestige joggers', 'Calça de moletom verde com logo "streetwear". Casual, confortável e sofisticada.', 469.00, 6, '/img/produtos/imgl3.png'),
('Titan Noir Sweatshirt', 'Moletom preto luxuoso com logo "Streetwear". Elegância minimalista e conforto superior.', 479.00, 11, '/img/produtos/imgl4.png'),
('Velvet Shadow Joggers', 'Calça jogger preta com bordado sofisticado e conforto elevado.', 489.00, 3, '/img/produtos/imgl5.png'),
('Evergreen Street Tee', 'Camiseta verde oversized, casual e sofisticada, com um toque de estilo urbano.', 509.00, 4, '/img/produtos/imgl6.png'),
...
('lúmen argentis', 'Pulseira de elos prateados radiantes, feita para refletir a luz de quem a carrega com autoridade e elegância.', 209.00, 11, '/img/produtos/acessorios/imga3.png'),
('eclipse side', 'Um colar singular, capturando a essência das estrelas e um brilho único que transcende o tempo.', 220.00, 9, '/img/produtos/acessorios/imga4.png'),
...
('Urban Edge', 'Conjunto masculino confortável e estiloso para o dia a dia.', 1890.00, 2, '/img/produtos/IMGA0.png'),
('Urban Grace', 'Conjunto feminino minimalista e sofisticado.', 1890.00 , 0, '/img/produtos/IMGA00.png');
